...
class ModConfigScreen(parent: Screen?) : GameOptionsScreen(
    ...
    override fun init() {
        ...
        val doneButton =
            ButtonWidget(width / 2 - 155 + 160, height - 29, 150, 20, ScreenTexts.DONE) { doneButtonPressed() }
    ...
    override fun render(matrices: MatrixStack?, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        drawCenteredTextWithShadow(matrices, textRenderer, title.asOrderedText(), width / 2, 8, 16777215)
