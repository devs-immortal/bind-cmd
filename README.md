...
![Minecraft 26.1](https://img.shields.io/badge/Minecraft-26.1-yellowgreen)

The BindCommands mod allows players to bind Minecraft commands to specific keys on their keyboard, making it easier and faster to execute commands in the game. The mod is built using the [Fabric](https://fabricmc.net/) mod loader and is compatible with Minecraft versions from 1.16.5 up to 26.1.
...
1. Download and install [Fabric](https://fabricmc.net/use/installer/) for Minecraft 26.1.
2. Download BindCommands and [Mod Menu](https://github.com/TerraformersMC/ModMenu) mods.
